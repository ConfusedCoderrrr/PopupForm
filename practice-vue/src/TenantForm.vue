<template style="position:relative">
    <Cmp v-if="isVisible"
      ...
      style="position: absolute; right: 3%; left: 3%;"/>
    <div
      style="
        position: relative;
        display: flex;
    ...
    >
      ...
      >
        ...
        <el-table-column prop="expression" label="Expression" width="200" />
        <el-table-column prop="period" label="Period" width="150" />
        <el-table-column prop="silencePeriod" label="Silence Period" width="150" />
